"""
Django settings for mute_silence_dev_90637 project.
...
ROOT_URLCONF = 'mute_silence_dev_90637.urls'
...
WSGI_APPLICATION = 'mute_silence_dev_90637.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mute_silence_dev_90637 API",
    "DESCRIPTION": "API documentation for mute_silence_dev_90637 App",
    "VERSION": "v1",
}
